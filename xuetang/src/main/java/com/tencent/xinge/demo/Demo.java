...
// 易用接口
 	...
 	System.out.println(XingeApp.pushAccountAndroid(2100166752, "a3e270f5e83b83b611da3e5472c6bf6f", "test", "测试", "stue062e9e3a4c24c478677580bce3a0e60"));
...
//		System.out.println(XingeApp.pushTokenIos(000L, "secretKey", "测试", "token", XingeApp.IOSENV_DEV));
	//System.out.println(XingeApp.pushAccountIos(2200166753l, "caef7daddb58cc91555ff5b7f6c697e2", "测试", "8e32e410-4d1a-4959-acaf-1a3fca249059", XingeApp.IOSENV_PROD));
...
//      System.out.println(ret);
	...
	public Demo()
	{
		...
		custom2.put("key1", "value2");
		custom2.put("key2", 22);
		custom.put("key3", custom2);
